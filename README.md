...
immanuella = {
    ...
    "currently": "Building, contributing, learning, and creating impact"
}
```
...
My current interests include **AI engineering, intelligent product development, open-source collaboration, and scalable full-stack systems**.
...
[![PR #2975](https://img.shields.io/badge/View-PR%20%232975-8B5CF6?style=flat-square&logo=github&logoColor=white)](https://github.com/carlos-emr/carlos/pull/2975)

My contribution remediates a **CRLF log-injection vulnerability** across 6 logging sites — approved by reviewers, pending final merge. I authored the `LogSanitizer` and `UploadedFileUtils` utility classes with unit test coverage, following the project's Conventional Commits and DCO workflow.

**Technologies:** Java 21, Spring, HL7/FHIR, JUnit, Git
...
**An intelligent graduation-planning platform that turns academic complexity into a personalized path toward graduation.**

[![GradPath Repository](https://img.shields.io/badge/View%20Project-GradPath-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Ememobong28/GradPath)
...
Built a vector-embedding cache system that reduced execution time on a dataset of more than one million records from approximately **1 hour 58 minutes to 3 minutes 58 seconds**.
...
Developed a backend platform feature that improved upgrade-plan creation efficiency and expanded automated test coverage using Java and JUnit.
...
Designed and built TechHive, a full-stack internship platform with personalized matching and real-time student-employer messaging.
...
**Founder & President, Girls Who Code Club @ Philander Smith University** — founded the university's first chapter in Nov 2023 and grew it into an active chapter running for three consecutive years, engaging 15+ female students in coding.

Also active in: **Student Government Association** (Vice President), **ColorStack**, **Rewriting the Code**, **CodePath**, **Black Sisters in STEM**, **HeadStart Fellowship**, **Netflix & Formation Program**, and as a **Google Generation Scholar**.

I care deeply about helping more students, especially women and students from underrepresented backgrounds, feel supported as they enter technology.
...
I'm always interested in conversations about **software engineering, artificial intelligence, open source, product development, and opportunities to build technology with meaningful impact**.
